class IndicatorsService
    class << self
        def indicators(report_id)
            ...
            u_1_percentil_99 = calculate_percentile(array_u_1, 99, "u1_99")
            u_1_percentil_95 = calculate_percentile(array_u_1, 95, "u1_95")
            u_1_percentil_5 = calculate_percentile(array_u_1, 5, "u1_5")
            ...
            u_2_percentil_99 = calculate_percentile(array_u_2, 99, "u2_99")
            u_2_percentil_95 = calculate_percentile(array_u_2, 95, "u2_95")
            u_2_percentil_5 = calculate_percentile(array_u_2, 5, "u2_5")
            ...
            u_3_percentil_99 = calculate_percentile(array_u_3, 99, "u3_99")
            u_3_percentil_95 = calculate_percentile(array_u_3, 95, "u3_95")
            u_3_percentil_5 = calculate_percentile(array_u_3, 5, "u3_5")
            ...
            i_1_percentil_99 = calculate_percentile(array_i_1, 99, "i1_99")
            i_1_percentil_95 = calculate_percentile(array_i_1, 95, "i1_95")
            i_1_percentil_5 = calculate_percentile(array_i_1, 5, "i1_5")
            ...
            i_2_percentil_99 = calculate_percentile(array_i_2, 99, "i2_99")
            i_2_percentil_95 = calculate_percentile(array_i_2, 95, "i2_95")
            i_2_percentil_5 = calculate_percentile(array_i_2, 5, "i2_5")
            ...
            i_3_percentil_99 = calculate_percentile(array_i_3, 99, "i3_99")
            i_3_percentil_95 = calculate_percentile(array_i_3, 95, "i3_95")
            i_3_percentil_5 = calculate_percentile(array_i_3, 5, "i3_5")
            ...
            p_fetot_cap_percentil_99 = calculate_percentile(array_p_fetot_cap, 99, "p_fetot_cap_99")
            p_fetot_cap_percentil_95 = calculate_percentile(array_p_fetot_cap, 95, "p_fetot_cap_95")
            p_fetot_cap_percentil_5 = calculate_percentile(array_p_fetot_cap, 5, "p_fetot_cap_5")
            ...
            p_fetot_ind_percentil_99 = calculate_percentile(array_p_fetot_ind, 99, "p_fetot_ind_99")
            p_fetot_ind_percentil_95 = calculate_percentile(array_p_fetot_ind, 95, "p_fetot_ind_95")
            p_fetot_ind_percentil_5 = calculate_percentile(array_p_fetot_ind, 5, "p_fetot_ind_5")
            ...
            p_fund_tot_percentil_99 = calculate_percentile(array_p_fund_tot, 99, "p_fund_tot_99")
            p_fund_tot_percentil_95 = calculate_percentile(array_p_fund_tot, 95, "p_fund_tot_95")
            p_fund_tot_percentil_5 = calculate_percentile(array_p_fund_tot, 5, "p_fund_tot_5")
            ...
            q_tot_cap_percentil_99 = calculate_percentile(array_q_tot_cap, 99, "q_tot_cap_99")
            q_tot_cap_percentil_95 = calculate_percentile(array_q_tot_cap, 95, "q_tot_cap_95")
            q_tot_cap_percentil_5 = calculate_percentile(array_q_tot_cap, 5, "q_tot_cap_5")
            ...
            q_tot_ind_percentil_99 = calculate_percentile(array_q_tot_ind, 99, "q_tot_ind_99")
            q_tot_ind_percentil_95 = calculate_percentile(array_q_tot_ind, 95, "q_tot_ind_95")
            q_tot_ind_percentil_5 = calculate_percentile(array_q_tot_ind, 5, "q_tot_ind_5")
            ...
            thd_u_1_percentil_99 = calculate_percentile(array_thd_u_1, 99, "thd_u_1_99")
            thd_u_1_percentil_95 = calculate_percentile(array_thd_u_1, 95, "thd_u_1_95")
            thd_u_1_percentil_5 = calculate_percentile(array_thd_u_1, 5, "thd_u_1_5")
            ...
            thd_u_2_percentil_99 = calculate_percentile(array_thd_u_2, 99, "thd_u_2_99")
            thd_u_2_percentil_95 = calculate_percentile(array_thd_u_2, 95, "thd_u_2_95")
            thd_u_2_percentil_5 = calculate_percentile(array_thd_u_2, 5, "thd_u_2_5")
            ...
            thd_u_3_percentil_99 = calculate_percentile(array_thd_u_3, 99, "thd_u_3_99")
            thd_u_3_percentil_95 = calculate_percentile(array_thd_u_3, 95, "thd_u_3_95")
            thd_u_3_percentil_5 = calculate_percentile(array_thd_u_3, 5, "thd_u_3_5")
            ...
            thd_i_1_percentil_99 = calculate_percentile(array_thd_i_1, 99, "thd_i_1_99")
            thd_i_1_percentil_95 = calculate_percentile(array_thd_i_1, 95, "thd_i_1_95")
            thd_i_1_percentil_5 = calculate_percentile(array_thd_i_1, 5, "thd_i_1_5")
            ...
            thd_i_2_percentil_99 = calculate_percentile(array_thd_i_2, 99, "thd_i_2_99")
            thd_i_2_percentil_95 = calculate_percentile(array_thd_i_2, 95, "thd_i_2_95")
            thd_i_2_percentil_5 = calculate_percentile(array_thd_i_2, 5, "thd_i_2_5")
            ...
            thd_i_3_percentil_99 = calculate_percentile(array_thd_i_3, 99, "thd_i_3_99")
            thd_i_3_percentil_95 = calculate_percentile(array_thd_i_3, 95, "thd_i_3_95")
            thd_i_3_percentil_5 = calculate_percentile(array_thd_i_3, 5, "thd_i_3_5")
            ...
            u_percent_percentil_99 = calculate_percentile(array_u_percent, 99, "u_percent_99")
            u_percent_percentil_95 = calculate_percentile(array_u_percent, 95, "u_percent_95")
            u_percent_percentil_5 = calculate_percentile(array_u_percent, 5, "u_percent_5")
            ...
            i_percent_percentil_99 = calculate_percentile(array_i_percent, 99, "i_percent_99")
            i_percent_percentil_95 = calculate_percentile(array_i_percent, 95, "i_percent_95")
            i_percent_percentil_5 = calculate_percentile(array_i_percent, 5, "i_percent_5")
